...
IdentifyImage - Triggered by placement of file in S3; comparing image against each reference image until a clear match is determined. Image moved to separate S3 location; may add dynamo logic in future.
